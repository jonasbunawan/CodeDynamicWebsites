<?php
	...
	define("TITLE", "Contact Us | Jonas Bunawan");
		...
		<?php
			...
			if (isset($_POST['contact_submit'])){
				...
				if (has_header_injection($name) || has_header_injection($email)) {
					die(); // If true, application will stop running
				}
				
				if( !$name || !$email || !$message){
					
					echo '<h4 class="error">All fields are required to proceed along.</h4><a href="contact.php" class="button block">Go back and try again</a>';
					exit;
				...
				$mail	= new PHPMailer;
				$mail	-> SMTPSecure = 'ssl';
				$mail	-> Username = "jonas_bun@yahoo.com";
				$mail	-> Password = "230891Jb.";
				$mail	-> AddAddress("jonas_bun@yahoo.com", "Jonas Bunawan");
				$mail	-> FromName	= "Jonas Bunawan";
				$mail	-> Subject	= "$name sent you a message via your online profile contact form";
				...
				/* // Add the recipient email to a variable
				 $to			= "jonas_bun@yahoo.com";
				
				// Create a subject
				$subject	= "$name sent you a message via your online profile contact form";
				...
				// Send the email!
				$mail = mail('jonas_bun@yahoo.com', $subject, $message, $headers);
				*/
